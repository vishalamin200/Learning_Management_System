...
const CatalogContent = ({ isActive }) => {
    ...
    const courseList = ['Web Development', 'Data Science', 'Machine Learning', 'MySql', 'Cloud Computing', 'Data Structures', 'Operating System', 'Computer Networks', 'Java', 'System Design', 'UI/UX', 'C++']

    return (

        <div id="catalogContext" className={`absolute left-40 top-[9vh] z-40 flex w-full border-2 border-black bg-white text-black md:w-[65vw] ${isActive ? "translate-y-0" : "-translate-y-[200%]"} transition-all duration-500 ease-in-out`}>
            ...
            <div className="items-around flex w-[40%] flex-col justify-around bg-[#10162F] p-5 px-8 text-white md:w-[35%] lg:w-[28%] ">
                ...
                <button onClick={() => navigate('/course')} className="btn btn-md bg-[#FFD301] hover:bg-[rgb(253,220,57)]">Explore All Courses</button>
            </div>
