...
const CommunityContent = ({isActive}) => {
    return (
        <div className={`absolute right-1/2 top-[9vh] z-40 flex w-60 flex-col items-center justify-center space-y-5  border-2 border-black bg-white py-5 text-lg text-black ${isActive? "translate-y-0" : "-translate-y-[200%]"} transition-all duration-500 ease-in-out` }>
