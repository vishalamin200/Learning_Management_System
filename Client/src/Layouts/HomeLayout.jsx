...
const HomeLayout = ({ children }) => {
    ...
    return (
        <div className="relative w-screen">
            ...
            <div id="drawer" className={` absolute left-0 top-8  flex h-[72vh]  w-screen flex-col rounded-lg bg-slate-400 text-white md:h-[90vh] md:w-[30vw] ${isDrawerOpen ? 'translate-x-0' : '-translate-x-full'} z-40 transition-all  duration-500 ease-in-out`}>
